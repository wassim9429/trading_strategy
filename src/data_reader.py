...
def get_data(index = 'INPX', start_date='2010-01-01', end_date = '2016-12-31' ):
	panel_data = data.DataReader(index, 'yahoo', start_date, end_date)
	return panel_data

def save_data(index = 'INPX', start_date='2010-01-01', end_date = '2016-12-31' ):
...
def import_data(index = 'INPX', start_date='2010-01-01', end_date = '2016-12-31' ):
